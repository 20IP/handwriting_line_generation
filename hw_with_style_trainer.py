...
import timeit
import util, string_utils, error_rates
from data_loaders import getDataLoader
from collections import defaultdict
import random, json, os
from hw_dataset import PADDING_CONSTANT
...
#----------------------
        ...
        for name in losses.keys():
            ...
            if self.balance_loss and 'generator' in name and 'auto-gen' in lesson:
                ...
                loss += losses[name]
                # print(f"Total loss updated: {loss}")
        ...
        with torch.no_grad():
            ...
            for batch_idx, instance in enumerate(self.valid_data_loader):
                ...
                if self.curriculum:
                    ...
                    pred, losses = self.run_hwr(instance)
                    # print(pred, recon, losses)
                    #
                # result = self.run_hwr(instance)
                # print(result)  # Kiểm tra xem hàm trả về gì
                    #
