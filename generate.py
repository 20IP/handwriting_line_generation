        ...
        def get_valid_data_loader():
            ...
            if valid_data_loader is None:
                if not test:
                    ...
                    test_data_loader, _ = getDataLoader(config)
    ...
    with torch.no_grad():
        while True:
            ...
            if action=='done' or action=='exit' or 'action'=='quit' or action=='q':
                exit()
            elif action[0]=='h': #help  ### Марія-Христина-військовослужбóвиця
                print('Options:')
