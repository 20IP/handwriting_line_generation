...
import numpy as np
import hw_dataset
import author_hw_dataset
# import author_rimeslines_dataset
...
def getDataLoader(config):
        ...
        if data_set_name=='HWDataset':
            return withCollate(hw_dataset.HWDataset,
                               hw_dataset.collate,
                               batch_size,
                               valid_batch_size,
                               shuffle,
            ...
            return withCollate(author_hw_dataset.AuthorHWDataset,
